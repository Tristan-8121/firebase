...
mylamp_On.onclick = function(){
    ...
    // WED -> FIREBASE
    firebase.database().ref("FORESTFIREWARNING/NODE2").update({
            CANHBAO: "ON"})
...
// FIREBASE -> WEB
firebase.database().ref("FORESTFIREWARNING/NODE2/CANHBAO").on("value",function(snapshot){
...
// FIREBASE -> WEB
//ngưỡng nhiệt độ
firebase.database().ref("FORESTFIREWARNING/NODE2/p-NHIETDO/").on("value",function(snapshot){
...
// Ngưỡng độ ẩm 
firebase.database().ref("FORESTFIREWARNING/NODE2/p-DOAM/").on("value",function(snapshot){
...
// Ngưỡng khoi
firebase.database().ref("FORESTFIREWARNING/NODE2/p-KHOI/").on("value",function(snapshot){
